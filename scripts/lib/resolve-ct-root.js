...
/**
 * Resolve the Claude-Toolkit source root directory.
 *
 * Tries, in order:
 ...
 *                                    contains CT scripts. Default: 'scripts/lib/utils.js'
 * @returns {string} Resolved CT root path
 */
function resolveCtRoot(options = {}) {
 ...
 *
 * This is the minified form of resolveCtRoot() suitable for use in
