 ...
 *
 * Bootstrap loader for the CT SessionStart hook.
 *
 ...
 *   2. Resolves the CT plugin root directory (via CLAUDE_PLUGIN_ROOT env var
...
/**
 * Returns true when `candidate` looks like a valid CT plugin root, i.e. the
...
process.stderr.write(
  '[SessionStart] WARNING: could not resolve CT plugin root; skipping session-start hook\n'
);
process.stdout.write(raw);
