...
* 项目：`${XDG_DATA_HOME:-~/.local/share}/claude-toolkit-homunculus/projects/<project-hash>/observations.jsonl`
* 全局后备：`${XDG_DATA_HOME:-~/.local/share}/claude-toolkit-homunculus/observations.jsonl`
...
* 项目：`${XDG_DATA_HOME:-~/.local/share}/claude-toolkit-homunculus/projects/<project-hash>/instincts/personal/`
* 全局：`${XDG_DATA_HOME:-~/.local/share}/claude-toolkit-homunculus/instincts/personal/`（用于通用模式）
